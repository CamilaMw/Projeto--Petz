...
import Model.ItemCompraTableModel;
import Main.Compra;
import Main.Fornecedor;
import Main.ItemCompra;
import Main.Produto;
import Situação.Situacao;
import java.util.Date;
import javax.swing.JOptionPane;

/**
 * Tela de lançamento de compra
 *
 * @author Camila
 */
public class LancamentoCompra extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btNovo.setForeground(new java.awt.Color(0, 153, 255));
        btNovo.setText("Novo");
        ...
        btSalvar.setForeground(new java.awt.Color(51, 204, 0));
        ...
        btFinalizar.setForeground(new java.awt.Color(102, 0, 102));
        ...
        pnForm.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 5, 0), javax.swing.BorderFactory.createTitledBorder(null, "Formulário", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(102, 153, 255)))); // NOI18N
        ...
        pnFormItens.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 5, 0), javax.swing.BorderFactory.createTitledBorder(null, "Formulário", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(102, 153, 255)))); // NOI18N
    ...
    private void habilitarFormulario(boolean formularioHabilitado) {
        btNovo.setEnabled(!formularioHabilitado);
        btSalvar.setEnabled(formularioHabilitado);
        btFinalizar.setEnabled(formularioHabilitado);
        btExcluir.setEnabled(formularioHabilitado);
        btCancelar.setEnabled(formularioHabilitado);
        ftfFornecedor.setEnabled(formularioHabilitado);
        btFornecedor.setEnabled(formularioHabilitado);
        ftfDataCompra.setEnabled(formularioHabilitado);
        ftfValorTotal.setEnabled(formularioHabilitado);
        ftfProduto.setEnabled(formularioHabilitado);
        btProduto.setEnabled(formularioHabilitado);
        spQuantidade.setEnabled(formularioHabilitado);
        ftfValorUnitario.setEnabled(formularioHabilitado);
        btAdicionarItem.setEnabled(formularioHabilitado);
        btRemoverItem.setEnabled(formularioHabilitado);
        tbGrade.setEnabled(!formularioHabilitado);
    ...
    private void carregarGrade() {
        CompraTableModel Telas = (CompraTableModel) tbGrade.getModel();
        try {
            Telas.setDados(compraDAO.listarTodos());
        } catch (Exception ex) {
