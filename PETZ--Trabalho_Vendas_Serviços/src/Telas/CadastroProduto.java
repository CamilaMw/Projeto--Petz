...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btSalvar.setForeground(new java.awt.Color(0, 255, 0));
        ...
        pnForm.setForeground(new java.awt.Color(30, 30, 30));
        ...
        ftfPrecoVenda.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftfPrecoVendaActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        pnForm.add(jLabel1, new java.awt.GridBagConstraints());

        pnConteudo.add(pnForm, java.awt.BorderLayout.PAGE_START);

        tbGrade.setAutoCreateRowSorter(true);
        tbGrade.setBorder(javax.swing.BorderFactory.createCompoundBorder());
    ...
    private void ftfPrecoVendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftfPrecoVendaActionPerformed

    }//GEN-LAST:event_ftfPrecoVendaActionPerformed
    ...
    private void habilitarFormulario(boolean formularioHabilitado) {
        ...
        ftfNome.setEnabled(formularioHabilitado);
        ftfPrecoCompra.setEnabled(formularioHabilitado);
        ftfPrecoVenda.setEnabled(formularioHabilitado);
