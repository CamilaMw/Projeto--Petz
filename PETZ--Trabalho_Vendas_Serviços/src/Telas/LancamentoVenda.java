...
public class LancamentoVenda extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btNovo.setForeground(new java.awt.Color(0, 153, 204));
        btNovo.setText("Novo");
        ...
        btSalvar.setForeground(new java.awt.Color(0, 255, 51));
    ...
    private void habilitarFormulario(boolean formularioHabilitado) {
        ...
        ftfCliente.setEnabled(formularioHabilitado);
        btCliente.setEnabled(formularioHabilitado);
        ftfDataVenda.setEnabled(formularioHabilitado);
    ...
    private void carregarGrade() {
        VendaTableModel Telas = (VendaTableModel) tbGrade.getModel();
        try {
            Telas.setDados(vendaDAO.listarTodos());
        } catch (Exception ex) {
